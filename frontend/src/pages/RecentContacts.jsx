...
export default function RecentContacts() {
  ...
  return (
    <div className='max-w-[480px] mx-auto min-h-screen bg-bg flex flex-col'>
      ...
      {contacts.length > 0 || search || category !== 'All' ? (
        <>
                  ...
                  >
                    ...
                    <div className='flex-1 min-w-0'>
                      <p className='text-[14px] font-bold text-gray-900 truncate'>
                        {c.name} <span className='font-normal text-gray-500'>{c.company}</span>
                      </p>
                      {c.relationshipType && (
                        <span className='inline-block mt-1 px-2.5 py-0.5 rounded-full border border-forest/30 text-forest text-[11px] font-medium capitalize'>
                          {c.relationshipType}
                        </span>
                      )}
                    </div>
