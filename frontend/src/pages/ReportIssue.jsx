    ...
    <div className='max-w-[480px] mx-auto min-h-screen bg-bg flex flex-col'>
      ...
      <div className='flex-1 px-5 pt-6 pb-10'>
        <p className='text-[13px] text-gray-500 mb-6'>
          Let us know what went wrong. This will open your email app with the details pre-filled, sent to {SUPPORT_EMAIL}.
        </p>

        <p className='text-[14px] font-bold text-gray-900 mb-2'>Issue Type</p>
        <select
          value={issueType}
        ...
        <textarea
          ...
          className='w-full rounded-2xl px-4 py-3 mb-8 text-[14px] text-gray-800 bg-white border-none outline-none resize-none'
        />
